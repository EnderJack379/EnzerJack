...
import InputSection from "../assets/Dependence/InputSection"; // Componente para el input y los botones
import Feedback from "../assets/Dependence/FeedBack"; // Componente para mensajes e intentos
import "../assets/Css/juego.css"; // Asegúrate de crear este archivo
